...
class RateService
{
    ...
    public function __construct(string $carrier, $userId = null)
    {
        ...
        // Determine API base URL based on environment and carrier
        ...
        $this->baseUrl = match($this->carrier) {
            ...
            'usps' => $env === 'production'
                ...
                : 'https://secure.shippingapis.com/sandbox', // adjust if USPS sandbox URL differs
    ...
    protected function getAccessToken()
    {
        ...
        // USPS does not require token, return null
        return null;
    }
    ...
    public function getRate(array $params)
    {
        ...
        if ($this->carrier === 'usps') {
            // Build USPS XML or JSON payload here as required
            // Example: use $this->key (username) and $params for origin/destination
            // Then call USPS API via Http::get/post
            throw new \Exception('USPS rate integration not implemented yet.');
        }

        throw new \Exception("Unsupported carrier: {$this->carrier}");
    }
}
